...
import { View, ScrollView, Text, TouchableOpacity, Dimensions, StyleSheet, Image } from 'react-native'
...
function AddProduct({ navigation }) {
    ...
    const [MidlePrice, setMidlePrice] = useState('');
    ...
    function activeInput(type) {
        ...
        if (type === 'SmallPrice' || SmallPrice !== '') setSmallSizeStatues(1);
        if (type === 'MidlePrice' || MidlePrice !== '') setMiddleStatues(1);
        if (type === 'bigPrice' || BigPrice !== '') setBigStatues(1);
    ...
    function unActiveInput(type) {
        ...
        if (type === 'SmallPrice' && SmallPrice == '') setSmallSizeStatues(0);
        if (type === 'MidlePrice' && MidlePrice == '') setMiddleStatues(0);
        if (type === 'bigPrice' && BigPrice == '') setBigStatues(0);
    ...
    const Add_Product = () => {
        dispatch(Add_Products(token, lang, nameAR, nameEN, price, detailesAr, detailesEn, availableKilos, Discount, quantity, SmallPrice, MidlePrice, BigPrice, MenueId, base64, navigation))
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: Colors.bg }}>
            ...
            <InputIcon
                ...
                onBlur={() => unActiveInput('SmallPrice')}
                onFocus={() => activeInput('SmallPrice')}
                inputStyle={{ borderColor: SmallSizeStatues === 1 ? Colors.sky : Colors.InputColor }}
                onChangeText={(e) => setSmallPrice(e)}
                value={SmallPrice}
            ...
            <InputIcon
                ...
                onBlur={() => unActiveInput('MidlePrice')}
                onFocus={() => activeInput('MidlePrice')}
                inputStyle={{ borderColor: MiddleStatues === 1 ? Colors.sky : Colors.InputColor }}
                onChangeText={(e) => setMidlePrice(e)}
                value={MidlePrice}
                keyboardType='numeric'
            ...
            <InputIcon
                ...
                onBlur={() => unActiveInput('BigPrice')}
                onFocus={() => activeInput('BigPrice')}
                inputStyle={{ borderColor: BigStatues === 1 ? Colors.sky : Colors.InputColor }}
                onChangeText={(e) => setBigPrice(e)}
                keyboardType='numeric'
                value={BigPrice}
