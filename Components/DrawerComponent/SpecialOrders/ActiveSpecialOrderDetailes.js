...
function ActiveSpecialOrderDetailes({ navigation }) {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ flex: 1 }}>
                ...
                < BTN title={i18n.t('orderProceedSuccess')} ContainerStyle={styles.LoginBtn} onPress={() => navigation.navigate('HomePage')} />
...
export default ActiveSpecialOrderDetailes
