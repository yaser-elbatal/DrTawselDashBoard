...
export const EditProducts = (token, lang, id, name_ar, name_en, price, details_ar, details_en, available_kilos, discount, quantity, menue_id, small_price, mid_price, large_price, image, navigation, ExtraProduct) => {
    return async (dispatch) => {
        await axios({
            method: 'POST',
